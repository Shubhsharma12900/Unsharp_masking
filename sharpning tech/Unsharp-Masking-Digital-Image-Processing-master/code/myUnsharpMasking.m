...
% s = load(filename);
p1 = imread('C:\Users\shubham sharma\Desktop\sharpning tech\baby.png');
p1 = p1(:,:,1);
% p1=imresize(p1, [1000 1000]);
halfwindow = 10 ;
amount = 0.1;
...
daspect ([1 1 1]);
axis tight;
%imwrite(p4, 'C:\Users\shubham sharma\Desktop\sharpning tech\Unsharp-Masking-Digital-Image-Processing-master\images\superMoonCrop.png' );
%imwrite(unsharp2,'C:\Users\shubham sharma\Desktop\sharpning tech\Unsharp-Masking-Digital-Image-Processing-master\images\superMoonCropSharpened.png');
